...
enum _PluginName {
  PLUGIN_BITCOIND2, PLUGIN_BITCOIND, PLUGIN_INJECTOR, PLUGIN_NETMINE_CONNECTOR, PLUGIN_NETMINE_LOGSERVER, PLUGIN_NETMINE_GETADDR, PLUGIN_NETMINE_VERBATIM, PLUGIN_NETMINE_CONSOLE
};
